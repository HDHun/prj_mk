...
<body class="container-fluid">
	...
	<div style="text-align: center; margin-top:100px;">
		<h4 style="font-weight:bold; ">장바구니</h4>
	</div>	
			<div class="container">
			...
			<div class="accordion accordion-flush col-8" id="accordionExample" style="display: inline-block;">
			  <div class="accordion-item">
			    ...
			    <div id="flush-collapseOne" class="accordion-collapse collapse show" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
			      <div class="accordion-body">
					<input class="form-check-input" type="checkbox" value=""id="checkboxAll" name="" style="vertical-align: middle; margin:0px;">
					<image src="/infra/resources/images/3.3.PNG" style="width: 100px;">
			      	<p style="display: inline; margin-left: 50px; margin-right: 50px;">[다향오리]훈제오리 150g</p>
	...
	<div class="card" style="width: 18rem; display: inline-block;">
	  <div class="card-body">
	    ...
	    <p class="card-text">경기도 파주시 가온로 256(가람마을 11단지 동문굿모닝힐아파트)</p>
	     <button class="btn container-fluid" style="color: purple; border-color: purple; font-weight: bold;" type="button">배송지 변경</button>
	    
	  </div>
	  <ul class="list-group list-group-flush">
	    <li class="list-group-item">상품금액<p style="float: right; margin:0px;">2,980원</p>
	    <br>상품할인 금액 <p style="float: right;margin:0px;">0원</p>
	    <br> 배송비 <p style="float: right;margin:0px;">3,000원</p>
	    </li>
	    <li class="list-group-item">결제 예정금액 <p style="float: right; margin:0px;">5,980원</p>
	    </li>
	    <li style="list-style: none;"><button class="btn container-fluid" style="color: white; background-color: purple; font-weight: bold;" type="button">주문하기</button></li>
	  </ul>
	</div>
</div>
